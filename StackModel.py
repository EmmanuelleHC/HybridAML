...
data_paths = {
    "train": {"raw": "Thesis/train.csv", "processed": "Thesis/processed_train_gcn.csv"},
    "val": {"raw": "Thesis/val.csv", "processed": "Thesis/processed_val_gcn.csv"},
    "test": {"raw": "Thesis/test.csv", "processed": "Thesis/processed_test_gcn.csv"},
}
...
def preprocess_and_load_data(raw_path, processed_path, scaler=None, downsample=False, is_train=False):
    ...
    if is_train:
        ...
        if scaler is None:
            ...
            print(f"Scaler loaded from scaler.pkl")
...
class TemporalGraphModelGCNBatch(nn.Module):
    def __init__(self, embedding_dim, lstm_hidden_dim, lstm_layers, gcn_hidden_dim, edge_attr_dim, num_nodes_global):
        ...
        self.gcn = GCNConv(embedding_dim, gcn_hidden_dim) 
