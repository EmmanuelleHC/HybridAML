...
data_paths = {
    "train": {"raw": "Thesis/train.csv", "processed": "Thesis/processed_train_sage.csv"},
    "val": {"raw": "Thesis/val.csv", "processed": "Thesis/processed_val_sage.csv"},
    "test": {"raw": "Thesis/test.csv", "processed": "Thesis/processed_test_sage.csv"},
}
